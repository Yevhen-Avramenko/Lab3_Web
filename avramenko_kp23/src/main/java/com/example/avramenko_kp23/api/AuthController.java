package com.example.avramenko_kp23.api;
import com.example.avramenko_kp23.openidconnect.OpenIdConnectProperties;
import com.example.avramenko_kp23.ssl.Ssl;
...
public class AuthController {
    ...
    public void callback(@RequestParam String code, HttpServletResponse response) throws Exception {
        ...
        RestTemplate restTemplate = Ssl.getRestTemplateWithoutSSL();
